...
async function createContractMonitor() {
    ...
    async function calProfitPair(block_number, dex_1, dex_2) {
        ...
        output_A = await new BigNumber(result);
        var profit = await new BigNumber(output_A).minus(input_A);
  ...
  # block: ${block_number}
    ...
    async function doSwap(tokenA,tokenB,inputAmount,router_1,router_2){
        const swapContract = '0xe2D848917358f7722fbe7c23A1eA97988268800F';
